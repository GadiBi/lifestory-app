    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <nav className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2 sm:gap-3">
            ...
            <span className="text-slate-900 font-bold text-xl">LifeStory Agent</span>
          </Link>
      ...
      <footer className="border-t border-slate-200 py-6 sm:py-8 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-sm">© 2024 LifeStory Agent. Your memories, beautifully preserved.</p>
